 ...
 * 自定义流式布局
 */
public class FlowLayoutFaBuTagsDing extends ViewGroup {

    private LayoutInflater mInflater;
    private boolean isColorful;

    public FlowLayoutFaBuTagsDing(Context context) {
        this(context, null);
    }

    public FlowLayoutFaBuTagsDing(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayoutFaBuTagsDing(Context context, AttributeSet attrs, int defStyle) {
...
//        Log.i("test", "sizeHeight" + sizeHeight);
        ...
        for (int i = 0; i < count; i++) {
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (onTagClickListener != null)
                        onTagClickListener.tagClickDing(tv.getText().toString(), finalI, mSelectMap, type);
                }
            });
            tv_select.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tv.setVisibility(VISIBLE);
                    if (onTagClickListener != null)
                        onTagClickListener.removeTagClickDing(tv_select.getText().toString(), finalI, mSelectMap, type);
    ...
    public interface OnTagClickListener {
        void tagClickDing(String text, int position, Map<String, String> selectMap, String type);
        void removeTagClickDing(String text, int position, Map<String, String> selectMap, String type);
    }
}
