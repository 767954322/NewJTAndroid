 ...
 * 自定义流式布局
 */
public class FlowLayoutBiaoQian extends ViewGroup {
    ...
    public FlowLayoutBiaoQian(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayoutBiaoQian(Context context, AttributeSet attrs, int defStyle) {
