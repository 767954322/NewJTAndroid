...
public class FlowLayoutSearch extends ViewGroup {
    ...
    public FlowLayoutSearch(Context context, AttributeSet attrs, int defStyle) {
...
//        Log.i("test", "sizeHeight" + sizeHeight);
        ...
        setPadding(UIUtils.getDimens(R.dimen.font_15),UIUtils.getDimens(R.dimen.font_15), UIUtils.getDimens(R.dimen.font_15), 0);
    }
    ...
    public void setData(String[] strings) {
        ...
        for (int i = 0; i < count; i++) {
            final TextView tv = (TextView) mInflater.inflate(R.layout.flowlayout_textview_search, this,
                    false);
