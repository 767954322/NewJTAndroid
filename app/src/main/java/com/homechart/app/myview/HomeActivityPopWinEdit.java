...
public class HomeActivityPopWinEdit extends PopupWindow {
    ...
    private void changeUI() {
        ...
        if (activityItemInfoDataBean != null) {
            if (activityItemInfoDataBean.getState_id().equals("1")) {//未开始

            } else if (activityItemInfoDataBean.getState_id().equals("2")) {//已结束
            ...
            } else if (activityItemInfoDataBean.getState_id().equals("3")) {//进行中
                ...
                long data = PublicUtils.diffDay(activityItemInfoDataBean.getEnd_time(), str, "yyyy-MM-dd HH:mm:ss");
            ...
            tv_activity_detail_content.setText("活动介绍："+activityItemInfoDataBean.getDescription());
        }
