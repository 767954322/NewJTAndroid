...
//        scaleAdapter.setDuration(500);
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_delete_icon:
                ...
                if (map_delete.size() > 0) {
                    CustomProgress.show(ShaiJiaListActivity.this, "正在删除...", false, null);
                    String delete_items = "";
                    ...
                    OkStringRequest.OKResponseCallback callBack = new OkStringRequest.OKResponseCallback() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            ToastUtils.showCenter(ShaiJiaListActivity.this, getString(R.string.error_delete_shaijia));
                        }
                        ...
                        public void onResponse(String s) {
                            try {
                                ...
                                if (error_code == 0) {
                                    ...
                                    CustomProgress.cancelDialog();
                                    ToastUtils.showCenter(ShaiJiaListActivity.this, error_msg);
                                }
                    ...
                    ToastUtils.showCenter(ShaiJiaListActivity.this, "请选择删除项");
                }
    ...
    public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
        ToastUtils.showCenter(ShaiJiaListActivity.this, "查看详情");
    }
    ...
    private void getListData(final String state) {
        ...
        OkStringRequest.OKResponseCallback callback = new OkStringRequest.OKResponseCallback() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                mLoadMoreFooterView.setStatus(LoadMoreFooterView.Status.GONE);
                ToastUtils.showCenter(ShaiJiaListActivity.this, UIUtils.getString(R.string.error_shaijia));
...
//        MyHttpManager.getInstance().getShouCangList("100050", (page_num - 1) * 20, "20", callback);
    ...
    private void jumpImageDetail(String item_id) {
       //友盟统计
        ...
        MobclickAgent.onEvent(ShaiJiaListActivity.this, "action50", map4);
        //ga统计
        MyApplication.getInstance().getDefaultTracker().send(new HitBuilders.EventBuilder()
