package com.homechart.app.utils.alertview;
...
//            tvAlertTitle.setVisibility(View.GONE);
    ...
    protected void initListView() {
        ...
        if (cancel != null && style == Style.Alert) {
            ...
            tvAlert.setTextColor(context.getResources().getColor(R.color.bg_007aff));
        ...
        if (mDatas.size() <= HORIZONTAL_BUTTONS_MAXCOUNT) {
            ...
            for (int i = 0; i < mDatas.size(); i++) {
                ...
                if (i != 0) {
                    ...
                    divier.setBackgroundColor(context.getResources().getColor(R.color.bg_d7d7db));
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) context.getResources().getDimension(R.dimen.size_1), LinearLayout.LayoutParams.MATCH_PARENT);
...
//                    tvAlert.setTextColor(context.getResources().getColor(R.color.textColor_alert_button_cancel));
                    tvAlert.setTextColor(context.getResources().getColor(R.color.case_text_tital_detail));
                    tvAlert.setOnClickListener(new OnTextClickListener(CANCELPOSITION));
                    position = position - 1;
                }
                //高亮按钮的样式
